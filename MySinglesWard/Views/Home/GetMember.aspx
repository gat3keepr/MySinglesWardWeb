    ...
    <table class="MemberText">
        <tr>
            ...
            <td class="rightColumn">
                ...
                <% } %>
                <% if (Model.memberSurvey.publishEmail || User.IsInRole("Bishopric"))
                   { %>
                <div class="display-label">
                    <strong>Email: </strong><a href="mailto:<%: Model.user.Email%>">
                        <%: Model.user.Email%></a></div>
                <% } %>
                <% if (Model.memberSurvey.publishCell || User.IsInRole("Bishopric"))
                   { %>
                <div class="display-label">
        ...
        <tr>
            ...
            <td class="rightColumn">
                ...
                <% } %>
                <% if (User.IsInRole("Clerk") && !User.IsInRole("Bishopric"))
                   { %>
                <div class="display-label">
                    <strong>Birthday: </strong>
                    <%: String.Format("{0:d/M/yyyy}", Model.memberSurvey.birthday)%></div>

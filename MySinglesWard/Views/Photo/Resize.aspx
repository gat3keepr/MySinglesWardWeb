...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div id="outer">
                    <div class="jcExample">
                        <div class="article">
                            ...
                            <% using (Html.BeginForm("Resize", "Photo", FormMethod.Post, new { enctype = "multipart/form-data" }))
                               {%>
                        ...
                        <div id="related-act-inner">
                            <div class="left">
                                <img src="../../Content/admin/images/forms/icon_edit.gif" width="21" height="21"
                                    alt="" /></div>
                            <div class="right">
                                Use cursor to select a portion of the picture to use for your profile and the ward
                                list.
                            </div>
                            <div class="clear">
                            </div>
    ...
    <div id="dialog" class="ui-dialog" title="Crop Your Photo">
        <p>
            Thanks for uploading your photo. Please use this crop tool to select a portion of
            the picture to use on the ward list. If you do not crop the picture, it will not
            appear on the ward list.</p>
    </div>
</asp:Content>

...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<table style="margin-left: 20px">
		<tr valign="top">
			<td>
				<% using (Html.BeginForm("UploadPicture", "Photo", FormMethod.Post, new { enctype = "multipart/form-data" }))
	   {%>
						...
						<div id="related-act-inner">
							<div class="left">
								<img src="../../Content/admin/images/forms/icon_edit.gif" width="21" height="21"
									alt="" /></div>
							<div class="right">
								Choose a picture file from your computer. This picture will be on the ward list
								so please use a photo that will help the bishop get to know you better. If you do
								not want your picture on the ward list, do not upload a picture.
							</div>
							<div class="clear">
							</div>
						</div>

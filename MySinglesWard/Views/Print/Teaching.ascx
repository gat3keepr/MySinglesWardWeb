...
<% using (Html.BeginForm("TeachingPrint", "Print", FormMethod.Post))
   {%>
<div class="printTable">
    <h2>Sunday School & Teaching</h2>
        <table class="printTable">
            ...
            <tr>
                <% using (Html.BeginForm("TeachingPrint", "Print", FormMethod.Get))
                   {%>
                <td>
                ...
                <% } %>
                <!--  <% using (Html.BeginForm("TeachingCSV", "Print", FormMethod.Get))
               {%>
            <td>

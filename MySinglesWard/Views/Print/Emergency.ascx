...
<% using (Html.BeginForm("EmergencyPrint", "Print", FormMethod.Post))
   {%>
<div class="printTable">
    <h2>Emergency Preparedness</h2>
        <table class="printTable">
            ...
            <tr>
                <% using (Html.BeginForm("EmergencyPrint", "Print", FormMethod.Get))
                   {%>
                <td>
                ...
                <% } %>
                <!--   <% using (Html.BeginForm("EmergencyCSV", "Print", FormMethod.Get))
               {%>
            <td>

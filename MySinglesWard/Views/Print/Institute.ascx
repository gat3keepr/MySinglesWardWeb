...
<% using (Html.BeginForm("InstitutePrint", "Print", FormMethod.Post))
   {%>
<div class="printTable">
    <h2>Institute</h2>
        <table class="printTable">
            ...
            <tr>
                <% using (Html.BeginForm("InstitutePrint", "Print", FormMethod.Get))
                   {%>
                <td>
                ...
                <% } %>
                <!-- <% using (Html.BeginForm("InstituteCSV", "Print", FormMethod.Get))
               {%>
            <td>

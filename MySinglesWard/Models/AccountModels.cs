    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public bool ResetPassword(string email)
        {
            try
            {
                ...
                string newPassword = _provider.ResetPassword(username, null);
                MSWtools._EmailPassword(username, newPassword, email);
                return true;
            }
            catch
            {
        ...
        public static string ErrorCodeToString(MembershipCreateStatus createStatus)
        {
            ...
            switch (createStatus)
            {
                ...
                case MembershipCreateStatus.DuplicateEmail:
                    return "A that e-mail address already exists. Please enter a different e-mail address.";
